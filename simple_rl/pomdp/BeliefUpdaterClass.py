...
class BeliefUpdater(object):
    ...
    def construct_transition_matrix(self, transition_func):
        '''
        Create an MLE of the transition probabilities by sampling from the
        transition_func multiple times.
        Args:
            transition_func: T(s, a) -> s'
    ...
    def construct_observation_matrix(self, observation_func, transition_func):
        '''
        Create an MLE of the observation probabilities by sampling from the 
        observation_func multiple times.
        Args:
