...
class POMDP(MDP):
    ...
    def __init__(self,
        ...
        MDP.__init__(self, actions, transition_func, reward_func,
                     sampled_init_state, gamma, step_cost)

        self.belief_updater = BeliefUpdater(self, transition_func, reward_func,
                                            observation_func,
                                            belief_updater_type)
    ...
    def execute_agent_action(self, action):
        ...
        new_belief = self.belief_updater_func(self.curr_belief, action,
                                              observation)
